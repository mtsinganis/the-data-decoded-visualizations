...
library(heatmaply)
library(showtext)
font_add_google("Poppins", "Momo Trust Display")
showtext_auto()
...
p <- ggplot(europe_long, aes(x = month, y = country, fill = occ_norm)) +
  ...
  theme_minimal(base_family = "Momo Trust Display", base_size = 23) +
  theme(
    panel.grid = element_blank(),
    # strip.text.y = element_text(face = "bold", angle = 0),
    strip.text = element_blank(),      # hides the text labels
...
plot_path <- paste0(project_path, "/plots", "/thumb.png")

ggsave(plot_path, p, width = 5.7, height = 7, dpi = 300)
```
