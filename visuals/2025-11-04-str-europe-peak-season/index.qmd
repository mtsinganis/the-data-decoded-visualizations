...
p <- ggplot(data = pct_above, aes(x = threshold, y = pct_of_year)) +
        ...
        guides(linetype = "none") +
        # annotate("rect", xmin = 0, xmax = 1, ymin = 0, ymax = 1, fill = NA, color = alpha("black", 0.5)) +
...
ggsave(plot_path, p, width = 8.6, height = 10.44238)
```
