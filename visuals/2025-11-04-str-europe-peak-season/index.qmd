...
p <- ggplot(europe_long, aes(x = month, y = country, fill = occ_norm)) +
        ...
        geom_curve(data = tibble(group = "Other", x = 13.75, y = 22, xend = 1.62, yend = 19),
        ...
        geom_curve(data = tibble(group = "Other", x = 13.75, y = 22, xend = 11.62, yend = 19),
          aes(x = x, y = y, xend = xend, yend = yend),
          arrow = arrow(length = unit(0.35, "cm"), angle = 23, type = "closed"),
          color = "grey10",
          # size = 0.4,
        ...
        geom_curve(data = tibble(group = "Europe", x = 13.75, y = 1, xend = 8.62, yend = 0.43),
          aes(x = x, y = y, xend = xend, yend = yend),
          arrow = arrow(length = unit(0.35, "cm"), angle = 23, type = "closed"),
          color = "grey10",
          # size = 0.4,
