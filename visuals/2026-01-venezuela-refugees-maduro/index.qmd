...
flags <- tibble(x = c(2013.45, 2015.45, 2016.15, 2018.45, 2019.15),
                y = c(40, 71, 71, 111, 111),
...
q <- ggplot(venezuela_area, aes(x = year, y = percentage_year, fill = country_group)) +
        ...
        labs(
            title = paste0("Relative burden of Venezuelan migration: ",
                           ...
                           " and ",
                           "<span style='color: #C0392B;'>Peru</span> take the<br>",
                           "lead from the U.S. as host countries during 2018 mass exodus"),
  ...
  theme_minimal(base_family = font_choice, base_size = 14) +
    ...
    geom_segment(data = tibble(x = 2013, xend = 2013, y = 4, yend = 40),
                     aes(x = x, xend = xend, y = y, yend = yend),
                     inherit.aes = FALSE,
                     linewidth = 0.6,
                     lineend = "round"
    ...
    geom_segment(data = tibble(x = 2018, xend = 2018, y = 0, yend = 118),
                     aes(x = x, xend = xend, y = y, yend = yend),
                     inherit.aes = FALSE,
                     linewidth = 0.6,
                     lineend = "round"
    ...
    geom_richtext(data = tibble(x = 2018.07, y = 111.25,
                                label = paste0("Once the mass exodus begins, ",
                                               ...
                                               " stabilize, as <b>Colombia and Peru</b>",
                                               " consistently absorb ~<b>",
                                               colombia_peru_percentage,
                                               " of the<br>migrant stock</b>")),
                      aes(x = x, y = y, label = label),
                      fill = NA, label.color = NA, hjust = 0, vjust = 1, size = 4,
                      color = "grey20", show.legend = FALSE, family = font_choice,
                      inherit.aes = FALSE) +
    ...
    annotate("rect", xmin = 2012.8, xmax = 2025.4,
                 ymin = 119.3, ymax = 125.3, fill = NA,  color = "grey20",
             linewidth = 0.6) +
    geom_text(data = tibble(x = 2013, y = 128.3, 
                            label = "Absolute number of migrants (thousands)"),
              aes(x = x, y = y, label = label),
              inherit.aes = FALSE, family = font_choice,
              size = 4, hjust = 0.02, color = "grey20")
