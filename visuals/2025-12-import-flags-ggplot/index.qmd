...
# data <- read_csv("visuals/2025-12-import-flags-ggplot/data/your_dataset.csv")
...
if (!dir.exists("visuals/2025-12-import-flags-ggplot/plots")) dir.create("visuals/2025-12-import-flags-ggplot/plots", recursive = TRUE)

ggsave("visuals/2025-12-import-flags-ggplot/plots/thumb.png", p, width = 8, height = 5, dpi = 220)
