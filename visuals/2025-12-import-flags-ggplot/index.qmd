...
date: "2025-12-16"
categories: [R, ggplot, flags, DataViz, "Corruption Index"]
...
![](plots/corruption_index_big_four_square.svg){width=100%}

### Rectangular flags with white background preserved

```{r export-visualization-rect}
p_rect <- p + geom_image(
...
![](plots/corruption_index_big_four_rect.svg){width=100%}