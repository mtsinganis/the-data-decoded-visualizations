...
p <- ggplot(cpi_data_region %>% filter(region != "global_average"),
      ...
      labs(x = NULL, y = NULL,
           title = paste0("<span style='color: #E72F52;'>Western Europe</span> consistently ranks as the least corrupt region,",
             "<br>", "while <b style='color: #7DC462;'>Sub-Saharan Africa</b> remains the most affected, with",
             "<br>", "minimal change across all regions since 2012"),
      ...
      inset_element(
                map_inset,
                left   = 0.25,   # center the inset horizontally
                right  = 0.75,
