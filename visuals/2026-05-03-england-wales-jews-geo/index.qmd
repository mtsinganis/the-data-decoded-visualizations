...
```{r project-path}
# Set project path
project_path <- file.path("visuals", "2026-05-england-wales-jews-geo")
```
...
jews_ward_map <- ggplot(london_final) +
  ...
  annotate("text", x = 53.65e4, y = 18.35e4, label = "Stamford\nHill West", fontface = "bold",
  ...
  annotate("text", x = 51.75e4, y = 18.6e4, label = "Golders\nGreen", fontface = "bold",
