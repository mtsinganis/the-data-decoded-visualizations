...
r <- ggplot(df_year_doy_norm_2,
    ...
    geom_image(data = tibble(x = sapply(c("2001-02-01", "2001-07-01", "2001-12-01"), as.Date),
                             y = rep(5.69, 3),
                             image = paste0(project_path, "/noun_icons/",
                                            rep_len(names(icon_colors), 3),
                                            ".png"),
               ...
               inherit.aes = FALSE) +
    scale_size_identity() +
    geom_curve(data = tibble(x = as.Date("2001-02-15"), y = 5.69,
                             xend = as.Date("2001-06-12"), yend = 5.69),
               aes(x = x, y = y, xend = xend, yend = yend),
               arrow = arrow(length = unit(0.35, "cm"), angle = 23, type = "closed"),
               color = "grey20",
               # size = 0.4,
    ...
    geom_curve(data = tibble(x = as.Date("2001-07-20"), y = 5.69,
                             xend = as.Date("2001-11-15"), yend = 5.69),
               aes(x = x, y = y, xend = xend, yend = yend),
               arrow = arrow(length = unit(0.35, "cm"), angle = 23, type = "closed"),
               color = "grey20",
               # size = 0.4,
