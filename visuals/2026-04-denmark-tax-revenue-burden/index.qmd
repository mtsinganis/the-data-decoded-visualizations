...
```{r project-path}
# Set project path
project_path <- file.path("visuals", "2026-04-denmark-tax-revenue-burden")
```
...
tax_revenue_chart <- ggplot(data = tax_long ,
    ...
    # ylim(0, 40) +
    labs(
        title = paste0("<span style='color: #c8102e;'>Denmark</span> Has the Highest Tax Burden Among Major Economies"),
        subtitle = paste("Tax revenue as % of national GDP, 1972–2025"),
